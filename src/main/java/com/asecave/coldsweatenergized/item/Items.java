package com.asecave.coldsweatenergized.item;
...
public class Items {
	...
	public static final RegistryObject<Item> HELMET = ITEMS.register("helmet", () -> new Item(new Item.Properties().group(ColdSweatGroup.COLD_SWEAT)));
